...
const myself = {
    name: "Dehyu DM Cassell",
    photo: "images/dehyu.jpg",
    favoriteFoods: ["pizza", "apple pie", "nachos", "ice cream", "Rice", "Yam"],
    hobbies: ["hiking", "programming", "eating", "Singing", "Reading"],
    placesLived: [
      {
      ...
      {
        place: "Bong County, Liberia",
        length: "10 year",
      },
      {
        place: "Harbel, Liberia",
        length: "10 years",
      },
    ],
  };
  ...
  const basicImg = "images/dehyu.jpg";
